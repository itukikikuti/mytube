...
const isAllowedVideoFile = (fileName: string): boolean => path.extname(fileName).toLowerCase() === '.mp4'
const encodeId = (fileName: string): string => Buffer.from(fileName, 'utf8').toString('base64url')
